...
<template>
    <nav
        class="bg-white px-2 sm:px-4  dark:bg-gray-900 fixed top-12 w-full z-20  border-b border-gray-200 dark:border-gray-600 ml-[250px] ">
        <div class="container flex flex-wrap justify-center mx-auto -ml-64">

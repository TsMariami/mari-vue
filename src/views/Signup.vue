                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-light text-gray-900 dark:text-gray-300">I accept the <a
                                    class="font-medium text-primary-800 hover:underline dark:text-primary-500"
                    ...
                    <p class="text-sm font-light text-gray-900 dark:text-gray-400">
                        ...
                        <RouterLink :to="{ name: 'signin' }" class="">
                            <a href="" class="font-medium text-primary-900 hover:underline dark:text-primary-500">Login
                                here</a>
                        </RouterLink>
                    </p>
                </form>
